  ...
  return (
    <div className="card" onClick={toPage}>
      <div className="card_image">
        <img src={require(`../../sliderImages/slider1.jpg`)} alt="" className={`card_img_second  ${pr && 'pr1'}`} />
        <img src={require(`../../sliderImages/slider2.jpg`)} alt="" className={`card_img_main ${pr && 'pr'}`} />
      </div>
